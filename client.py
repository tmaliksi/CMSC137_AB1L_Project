...
class Game:
	...
	def endgame(self):		#Have not checked if works. Made basis code for current build up in-case.
		if len(CARDS) == 4:
			for i in range(4):
					if(CARDS[i][0:1] == "1"):
						print("The player has completed a set of Aces!")
						print("Player has won!")
					elif(CARDS[i][0:1] == "11"):
						print("The player has completed a set of Jacks!")
						print("Player has won!")
					elif(CARDS[i][0:1] == "12"):
						print("The player has completed a set of Queens!")
						print("Player has won!")
					elif(CARDS[i][0:1] == "13"):
